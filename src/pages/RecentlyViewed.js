...
export function RecentlyViewed() {
  ...
  const getHistory = (e) => {
    ...
    let res = apiClient.post(
      apiClient.Urls.getHistory,
      {
        property_type: e || 'project',
      },
      true
    );
  ...
  return (
    <>
      <Header />
      {loader ? (
        <div className="display-col px-2 row topvilla_view">
          <div className="col">
            {' '}
            <Skeleton
              variant="rectangular"
          ...
          <div className="row topvilla_heading py-3 px-1">
            <div className=" d-flex justify-content-sm-between align-items-center col-md-12">
              <h1 onClick={() => console.warn('data is ', Data)}>
                Recently
                <span style={{ fontWeight: '700' }}> Viewed Properties </span>
              </h1>
            </div>
          </div>
          <div>
            {active ? (
              <button
                onClick={() => {
                  setActive(true), getHistory('project');
                }}
                className="landing-btn px-4 py-2 "
                style={{ background: 'rgb(227, 125, 50)' }}
              >
                Properties
              </button>
            ) : (
            ...
            {active ? (
              <button
                onClick={() => {
                  setActive(false), getHistory('plot');
                }}
                style={{ backgroundColor: '#d3d3d3', color: 'black' }}
                className="landing-btn px-4 py-2"
              >
