...
import keetown from '../../../public/images/keetown.jpeg';
import Image from 'next/image';
function Header({ header, staticLogo }) {
  return (
    ...
    >
      <div className="pl-4 d-flex align-items-center " style={{width:"28%"}}>
        <img
          src={`https://seller.estatedekho.com/${header?.logo}`}
          width={120}
          height={50}
        />
        {staticLogo && <Image className='mx-1' src={keetown} width={110} height={60} />}
      </div>
