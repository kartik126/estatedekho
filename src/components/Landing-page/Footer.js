...
import logo from '../../../public/images/danubelogo2.png';
  ...
  return (
    ...
    >
      <div className="col-sm-4  d-flex flex-column justify-content-center align-items-start px-5">
        <Image className="rounded-3" src={logo} width={200} height={60} />
      </div>
      <div
      ...
      >
        ...
        <div className="landing-pg-head">
          ...
          <a href="#amenities" style={{ fontSize: '13px' }}>
      ...
      <div className="py-5 col-sm-4" style={{ color: '#ffff' }}>
        ...
        <p style={{ textAlign: 'justify' }}>info@danubeproperties.ae</p>
      </div>
